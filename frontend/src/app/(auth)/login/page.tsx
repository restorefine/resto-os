      ...
      <div className="hidden lg:flex w-[46%] bg-black flex-col justify-between p-10 shrink-0">
        ...
        <div>
          ...
          >
            ...
            <span className="text-red-600" style={{ fontSize: "clamp(32px, 4vw, 52px)" }}>.</span>
          </div>

          <p className="mt-8 text-white/35 text-sm font-sans leading-relaxed max-w-xs">
            Internal command centre for managing clients, revenue, pipeline, and
            content for RestoRefine Studios, Glasgow.
          </p>
        </div>
        ...
        >
          ...
          <div className="lg:hidden mb-10">
            <span className="text-black font-black text-2xl tracking-tighter">
              AGENCY<span className="text-red-600">OS</span>
            </span>
          </div>
          ...
          <div className="mb-9">
            ...
            <p className="text-gray-500 text-sm font-sans leading-relaxed">
              Use your AgencyOS credentials to continue.
            </p>
          </div>
          ...
          <form onSubmit={handleSubmit(onSubmit)} noValidate className="space-y-5">
            ...
            <div>
              ...
              <input
                ...
                type="email"
                autoComplete="email"
                placeholder="you@restorefine.com"
